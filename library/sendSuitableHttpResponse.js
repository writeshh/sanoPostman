...
function sendSuitableHttpResponse(code, msg, data) {
	try {
		if (code === 200) {
			return StatusCode.sendSuccessResponse(msg, data);
		}
		if (code === 405) {
		...
		throw new Error(`Error while sending suitable error response ${err}`);
	}
}
